-- LSP Extra utilities and debugging commands
-- These are the useful commands and status functions from your old config

-- Create LSP restart command using the utility from core.lsp
vim.api.nvim_create_user_command('LspRestart', function()
  require('core.lsp').restart_lsp()
end, { desc = 'Restart LSP for current buffer' })

-- Show detailed LSP status for current buffer
...
-- Show LSP capabilities in detail
...
-- Show diagnostics count summary
...
-- Comprehensive LSP information command
...
-- Export functions globally for statusline use
