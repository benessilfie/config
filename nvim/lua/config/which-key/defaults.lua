return {
  ...
  u = {
    ...
    s = {
      ...
      s = { require('lualine').hide({unhide = true}), "Show Lualine" },
    },
    z = {
      name = "Manage Clutter",
      d = { require('config.utils').declutter_terminal, "Declutter Terminal" },
      c = { require('config.utils').clutter_terminal, "Clutter Terminal" },
    },
  },
  i = {
    name = "Sessions",
